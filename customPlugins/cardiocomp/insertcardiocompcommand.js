...
function createCardioCompTable(writer, editor) {
    ...
    if ( patientAge > 15 ) {
        ...
        return '<table class="cardiocomp-wrapper">' +
            ...
            '<td class="cardiocomp-editable-field" id="reffmoe">' +
            ...
            '<td class="cardiocomp-cell">cm/s</td>' +
            '<td class="cardiocomp-editable-field" id="reffmoa">' +
            ...
            '<td class="cardiocomp-cell">cm/s</td>' +
            '<td class="cardiocomp-editable-field" id="refes">' +
            (references['refes'] || '-') + '</td> ' +
            '</tr>' +
            ...
            '<td class="cardiocomp-cell">cm/s</td>' +
            '<td class="cardiocomp-editable-field" id="refel">' +
            (references['refel'] || '-') + '</td> ' +
            '</tr>' +
            ...
            '<td class="cardiocomp-editable-field" id="refrea">' +
            ...
            '<td class="cardiocomp-cell"> </td>' +
            '<td class="cardiocomp-editable-field" id="refmree">' +
            ...
            '<td class="cardiocomp-editable-field" id="reftdm">' +
            ...
            '<td class="cardiocomp-editable-field" id="refpsap">' +
            ...
            '<td class="cardiocomp-cell">mmHG</td>' +
            '<td class="cardiocomp-editable-field" id="refpead">' +
            ...
            '<td class="cardiocomp-editable-field" id="refvci">' +
            ...
            '<td class="cardiocomp-cell">mm</td>' +
            '<td class="cardiocomp-editable-field" id="refvcie">' +
            ...
            '<td class="cardiocomp-cell">mm</td>' +
            '<td class="cardiocomp-editable-field" id="refvvci">' +
